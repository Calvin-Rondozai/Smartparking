...
urlpatterns = [
    ...
    path('sensors/real-time/', views.get_real_time_sensor_data, name='get_real_time_sensor_data'),
    path('parking/availability/', views.get_parking_availability, name='get_parking_availability'),
    path('parking/statistics/', views.get_parking_statistics, name='get_parking_statistics'),
